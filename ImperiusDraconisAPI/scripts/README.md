...
3. Aplicar **017, 018, 019 y 020**, en ese orden, con el renderizador y comprobar una segunda ejecución:
...
python3 ImperiusDraconisAPI/scripts/render_mysql_batches.py \
  ...
  ImperiusDraconisAPI/ImperiusDraconisAPI/SQLMigrar/020_create_game_missions_battles.sql
```
...
6. Aplicar 017, 018, 019 y 020 a producción tras validar el respaldo y las pruebas; después desplegar API y frontend. El inicializador crea 017, pero **018, 019 y 020 requieren ejecución explícita previa al despliegue**.
