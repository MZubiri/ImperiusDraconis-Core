...
3. Aplicar **solo 017 y 018** con el renderizador y comprobar una segunda ejecución:
...
6. Aplicar 017 y 018 a producción tras validar el respaldo y las pruebas; después desplegar API y frontend. El inicializador crea 017, pero **018 requiere ejecución explícita previa al despliegue**.
